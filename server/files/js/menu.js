...
Menu.prototype.get_menu_buttons_html = function(context) {
    ...
    for (var i = 0; i < options.length; ++i) {
        ...
        var background_color = option.disabled ? '#DDDDDD' : '#FFFFFF';
        buttons_html += '<div><button style="border: 5px solid; border-color:#AAAAAA; background-color: ' + background_color + '" type="button" class="btn badge-pill btn-default btn-block btn-lg options_' + this.params.id + '" name="' +
